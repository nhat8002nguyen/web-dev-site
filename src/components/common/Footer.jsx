...
const benifits = [
	{
		...
		description: "Cung cấp miễn phí vận chuyển cho tất cả các sản phâm trên 500,000 đồng",
	...
	},
	{
		...
		description: "Chúng tôi đảm bảo cho chất lượng sản phẩm để bạn dễ dàng tin tường",
  ...
  return !visibleOnlyPath.includes(pathname) ? null : (
		<div>
			<div className="footer-benefits">
				{benifits.map(b => <BenefitItem key={b.id.toString()} {...b}/>)}
			</div>
